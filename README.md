# Веб-приложение «Витрина интернет-магазина» с использованием Spring Boot в реактивном стиле c Redis кэшем товаров, RESTful серсивом оплаты, аутентификацией и авторизацией. 
